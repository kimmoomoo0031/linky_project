...
//   Future<Map<String, dynamic>> refresh(@Body() Map<String, dynamic> body);
//
//   /// パスワードリセット用メール送信。
...
//   Future<Map<String, dynamic>> lineLogin(@Body() Map<String, dynamic> body);
//
//   /// Google ログイン用コールバック。
//   @POST(ApiEndpoints.authGoogleLogin)
//   Future<Map<String, dynamic>> googleLogin(@Body() Map<String, dynamic> body);
// }
//
//
